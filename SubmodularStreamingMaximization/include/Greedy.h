...
public:
     ...
     */
    Greedy(unsigned int K, SubmodularFunction<T> & f) : SubmodularOptimizer<T>(K,f) {}
     ...
     */
    Greedy(unsigned int K, std::function<data_t (std::vector<T> const &)> f) : SubmodularOptimizer<T>(K,f) {}
