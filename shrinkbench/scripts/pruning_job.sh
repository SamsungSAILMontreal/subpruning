...
# python prune_onelayer.py -s LayerInChangeChannel,LayerActGradChannel -b 8 -d CIFAR10 -m vgg11_bn_small -t channel -o Adam --task $SLURM_ARRAY_TASK_ID --ntasks $SLURM_ARRAY_TASK_COUNT --job $SLURM_ARRAY_JOB_ID

# python prune_onelayer.py -s all -b 4 -d CIFAR10 -m vgg11_bn_small -t channel -o Adam -f 0.075 --task $SLURM_ARRAY_TASK_ID --ntasks $SLURM_ARRAY_TASK_COUNT --job $SLURM_ARRAY_JOB_ID
