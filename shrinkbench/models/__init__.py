...
from .mnistnet import MnistNet, LeNet
...
from .cifar10_models.vgg_small import vgg11_bn_small, vgg11_bn_small_mnist, vgg13_bn_small, vgg16_bn_small, vgg19_bn_small
